...
namespace TheGramPost.EventBus
{
    public class RabbitMqPersistentConn : IRabbitMQPersistentConn
    {
        ...
        public bool TryConnect()
        {
            ...
            {
                Logger.Error("RabbitMQ couldn't connect, retrying in 5 seconds");
                Thread.Sleep(5000);
                _connection = _connectionFactory.CreateConnection();
            }
        ...
        public void CreateConsumerChannel()
        {
            ...
            _eventBusService = new EventBusRabbitMqImpl(this, _serviceProvider, RabbitMqChannels.GetPostsOfFollowers);
            _eventBusService.CreateConsumerChannel();
        }
